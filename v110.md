# Pointy Extension Language Specification
...
This document defines the Pointy Extension Language Specification version 1.1.0. The Pointy Extension Language is a domain-specific language for defining event-driven execution workflows with support for parallel processing, configurable execution attributes, and flexible executor management.
...
The Pointy Extension Language provides a declarative syntax for defining event execution workflows. It supports:
...
**Type:** String  
**Required:** No  
**Default:** System default executor
...
1. Sequential operator (`->`) linking
2. Explicit grouping with `{}`
3. Parallel execution grouping
...
### 7.3 Mixed Sequential and Parallel
