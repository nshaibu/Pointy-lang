...
1. **Mandatory initialisation**: All variable declarations must include a value
...
3. **Initialisation**: Always initialise variables with meaningful default values
...
### Error Examples
```
# Error: Invalid variable name (starts with a number)
@1retry = 3

# Error: Undefined variable reference
@timeout = undefined_var

# Error: Missing initialisation
@empty_var =
```
